 ...
 * @author Penna
 */
public class FrameDividaAdmin extends javax.swing.JFrame {

    private static Usuario usuario;

    public FrameDividaAdmin(Usuario usuario) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameDividaAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameDividaAdmin(usuario).setVisible(true);
            }
        });
    }
